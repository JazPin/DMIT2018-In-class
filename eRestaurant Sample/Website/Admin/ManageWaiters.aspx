...
<%@ Register Src="~/UserControl/MessageUserControl.ascx" TagPrefix="my" TagName="MessageUserControl" %>
...
<div data-style="bootstrap">
        <fieldset data-style="inline">
            <asp:Label ID="Label" runat="server" Text="Select Waiter" AssociatedControlID="WaiterDropDown" />
            <asp:DropDownList ID="WaiterDropDown" runat="server"></asp:DropDownList>
            <asp:LinkButton ID="ShowWiater" runat="server" Text="Show Waiter"/>  
        </fieldset>
